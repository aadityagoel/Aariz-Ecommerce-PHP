<?php
   ...
   $sql = "select * from categories order by added_on desc";
            ...
            <div class="card">
               <div class="card-header d-flex">
                  ...
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="manage_categories.php">Add Category</a>
                    </li>
                  </ul>
               </div>
               <!-- /.card-header -->
                  ...
                  <table id="example1" class="table table-hover table-head-fixed">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <?php 
                              echo "<button type='button' class='btn btn-info btn-sm'><a href='manage_categories.php?id=".$row['id']."' style='color: white;'>Edit</a></button>";
